# -*- coding: utf-8 -*-
# Generated by Django 1.10.5 on 2017-04-20 18:12
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True)),
                ('updated', models.DateTimeField(auto_now=True)),
                ('parrent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='sos.Material_Group')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='material',
            name='group',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='sos.Material_Group'),
        ),
        migrations.AddField(
            model_name='material',
            name='manufacturer',
